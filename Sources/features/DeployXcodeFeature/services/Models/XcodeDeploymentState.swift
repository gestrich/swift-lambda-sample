...
public struct XcodeSnapshot: Sendable, Equatable {
    ...
    public static var initial: XcodeSnapshot {
        XcodeSnapshot(
    ...
    public static func failed(reason: String, preserving prior: XcodeSnapshot?) -> XcodeSnapshot {
        XcodeSnapshot(
...
public enum XcodeUseCaseState: Sendable, Equatable {
    ...
    /// Progress info for Lambda process operations (native macOS process, not Docker)
