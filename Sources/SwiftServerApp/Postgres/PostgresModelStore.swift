...
public actor PostgresModelStore: PostgresModelStoreInterface {
    ...
    public init(eventLoop: EventLoop, configuration: PostgresConfiguration) async throws {
        ...
        // TLS configuration:
        // - Production (enableTLS=true): Use .prefer (attempts TLS, required by AWS RDS)
        // - Local development (enableTLS=false): Disable TLS (local Postgres has no valid certificate)
