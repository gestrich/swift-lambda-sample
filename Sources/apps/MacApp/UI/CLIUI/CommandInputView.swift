...
// MARK: - NSTextField wrapper for key interception

/// NSViewRepresentable wrapper for NSTextField with keyboard interception via delegate
private struct CommandTextField: NSViewRepresentable {
    ...
    class Coordinator: NSObject, NSTextFieldDelegate {
        ...
        func control(_ control: NSControl, textView: NSTextView, doCommandBy commandSelector: Selector) -> Bool {
            guard let textField = control as? CustomNSTextField else { return false }
...
/// Custom NSTextField with closures for key events
private class CustomNSTextField: NSTextField {
    var onTab: (() -> Void)?
    var onUpArrow: (() -> Void)?
