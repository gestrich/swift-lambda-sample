...
public struct BuildScript {
    ...
    /// Example: ./build.sh SwiftLambda linux/amd64 $GITHUB_TOKEN
    @CLICommand("")
    public struct Build {
        /// Build target name (required, e.g., "SwiftLambda")
...
public extension BuildScript.Build {
    ...
    /// - Parameter target: The build target name (e.g., "SwiftLambda")
    ...
    /// - Parameters:
    ///   - target: The build target name (e.g., "SwiftLambda")
